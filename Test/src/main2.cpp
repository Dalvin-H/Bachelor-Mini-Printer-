...
void setup() {
    ...
    if(!gcodeFile){
        Serial.println("Failed to open Gcode file!");
        return;
    }

    Serial.println("Starting Gcode processing...");
    ...
    double totalMs = (end-start)*0.001;
    Serial.print("\nFinished processing Gcode. Total time: "); Serial.print(totalMs); Serial.println(" ms");
